...
<title>Book Cover Designs | Creative Book Covers - <?php echo $brand;?> </title>
<meta name="keywords" content="">
<meta name="description" content="Looking for creative book covers? Our <?php echo $brand;?> specialize in captivating designs. Make your book stand out!">
         ...
         <div class="col-md-7" data-aos="fade-left" data-aos-duration="1200">
            ...
            <div class="trust">
               <div class="new_frm">
                  ...
                  <input type="hidden" name="route" value="/book-cover-design/">
      ...
      <div class="row align-items-center">
         <div class="col-md-6">
            ...
            <p class="py-3"> Our skilled designers use their expertise to design the perfect cover to make your
               ...
               <?php echo $brand;?>, you’ll have a book cover that is always on the front shelves.
            </p>
            <a href="javascript:;" onclick="setButtonURL();" class="btn btn-yellow">Start Project <i
