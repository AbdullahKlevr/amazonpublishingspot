...
<head>
    ...
    <title>Ebook Writing Services | Hire Ebook Writers - <?php echo $brand;?></title>
    <meta name="keywords" content="">
    <meta name="description" content="Need ebook writing services? Hire <?php echo $brand;?>! Our skilled ebook writers deliver quality content. Get your ebook project started today!">
            ...
            <div class="row align-items-center">
                <div class="col-md-7" data-aos="fade-left" data-aos-duration="1200">
                    ...
                    <p class="text-white py-3">
                        At <?php echo $brand;?>, our team of executive e-book writers take your ideas and transform
...
<input type="hidden" name="news" value="1">
    ...
    <section class="book-stone">
        <div class="container" data-aos="fade-up" data-aos-duration="1000">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h2>Take Your E-Books To The Next Level With <?php echo $brand;?></h2>
    ...
    <section class="self-publishing">
        <div class="container" data-aos="fade-down" data-aos-duration="1000">
            ...
            <div class="row ">
                <!-- <div class=""> -->
                <div class="col-md-4">
                    <div class="self-pub"> <img class="lazy"
                            src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                            data-src="assets/images/sp1.webp" alt="Logo">
                ...
                <div class="col-md-4">
                    <div class="self-pub"> <img class="lazy"
                            src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                            data-src="assets/images/sp2.webp" alt="">
                        <h3>Sales <span class="d-block">Dashboard</span></h3>
                        <p>We’ll provide you with a sales dashboard that is available 24/7 so you can keep track of book
                            sales and royalties.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="self-pub"> <img class="lazy"
                            src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                            data-src="assets/images/sp3.webp" alt="">
                        <h3>Quick Turnaround <span class="d-block">Time</span></h3>
                        <p>Our typical turnaround time for book publishing is 10-12 weeks, so you won’t be waiting long
                            before you’re a published author!</p>
                    </div>
                </div>
    ...
    <section class="cta">
        <div class="container" data-aos="zoom-in" data-aos-duration="1000">
            <div class="row align-items-center">
                ...
                <div class="col-md-4"> <img class="lazy"
                        src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                        data-src="assets/images/book-writng-sr.png" alt=""> </div>
                <div class="col-md-6">
        ...
        <div class="container" data-aos="slide-up" data-aos-duration="1000">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <p class="text-white pt-2 pb-3">Challenge us. We want to work with you to create the really cool
                        stuff.</p> <a href="javascript:;" onclick="setButtonURL();" class="btn btn-yellow">Start Project
                        <i class="fal fa-long-arrow-right"></i></a> <a class="btn btn-black"
                        href="tel:<?php echo $phone;?>"><i class="fas fa-phone-alt"></i> &nbsp; Call Now</a>
                </div>
                <div class="col-md-6"> <img class="lazy"
                        src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                        data-src="assets/images/cta-inner-before.png" alt="img"> </div>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center pb-5">
                ...
                <div class="col-md-6 text-right">
                    <a href="#" target="_blank"> <img class="lazy"
                            src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                            data-src="assets/images/review-trust.webp" alt="Logo" width="60%"> </a>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="testmonial-slider owl-theme owl-carousel">
                    <div class="item">
                        <div class="self-pub">
                            ...
                            <p><?php echo $brand;?> is a great place to get your book written. They have experienced
                                writers on board who actually walk extra miles to fulfil your expectations. I have
                                worked with them and got truly impressed.</p>
                        </div>
                    </div>
                    <div class="item">
                        <div class="self-pub">
                            ...
                            <p>I can highly recommend <?php echo $brand;?> as a fantastic company with really helpful
                                people that deliver great results on time. I could not have achieved this with out them.
                                Thank you <?php echo $brand;?>.</p>
                        </div>
                    </div>
                    <div class="item">
                        <div class="self-pub">
                            ...
                            <!--<h3>A Great Team</h3>-->
                            <p>This has been a delightful enriching experience, It is as someone is talking like you and
                                thinking the same way, direct to the point, and great timing. Special thanks for making
                                this Come true in a short period of time and thorough work.</p>
                        </div>
                    </div>
                    <div class="item">
                        <div class="self-pub">
                            ...
                            <p><?php echo $brand;?> has been wonderful in editing my book. They are working in a very
                                timely and responsive way. I really like working with them and have already recommended
                                them to several other people. A BIG THUMBS UP.</p>
                        </div>
                    </div>
                    <div class="item">
                        <div class="self-pub">
                            ...
                            <p>When I was struggling to publish my first book, I had no idea of the difficulties
                                involved. But when I got in touch with <?php echo $brand;?>, my book was publish within
                                few period with their expertise. Highly Recommended</p>
                        </div>
                    </div>
                    <div class="item">
                        <div class="self-pub">
                            ...
                            <p><?php echo $brand;?>, I have made a friend for life. It's one thing to call or feel like
                                a writer, but if you want all the bells and whistles in a completed writing. Trust me
                                call these people.Thanks alot for making my dream come true</p>
                        </div>
                    </div>
                    <!--<div class="item">-->
                    <!--  <div class="self-pub">-->
        ...
        <div class="container" data-aos="zoom-in-up" data-aos-duration="1200">
            <div class="row">
                <div class="col-md-12 pb-md-5 ">
                    ...
                    <p class="text-center pt-2 pb-4">Before contacting us you might want to check whether your question
                        is one of our frequently asked questions.</p>
                    <div id="accordion">
                        <div class="card">
                            <div class="card-header"> <a class="collapsed card-link" data-toggle="collapse"
                                    href="#collapseOne">Q. What will be
                        ...
                        <div class="card">
                            ...
                            <div id="collapseThree" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <p>Yes, the author has holds 100% film rights for her/his work. But you must notify
                                        us the detailed good news to spread socially. That is it. No commission. </p>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseSix" class="collapse" data-parent="#accordion">
                                <div class="card-body">
                                    <p> In approximately 7 to 14 days, from the time we have the computer typed
                                        manuscript, your written (or email) approval for print and the verified payment
                                        with us. However, some of the distribution channels may take longer time, but
                                        the book will be available in our store within time, with guarantee. </p>
                                </div>
                            </div>
                        </div>
                    </div>
