...
<script>
  gtag('event', 'conversion', {'send_to': 'AW-308326143/P2XaCP_xnJ4ZEP_dgpMB'});
        ...
        <title>Thank You | Worldwide Publisher </title>
    </head>
    <body class="">
    <?php
            ...
            <style>
                .form-box {
                    margin-top: 30px;
                        ...
                        <section id="banner" class="banner04 contact">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-7">
                                <div class="bnr-txt btn-tx-cp">
                                <h2 class="gradient-text"><?php if (isset($_REQUEST['thanksMsg'])) {
                                                                            echo $_REQUEST['thanksMsg'];
                                                                        } ?></h2>
                    <h2 class="gradient-text"><?php if (isset($_REQUEST['successMsg'])) {
                                                                            echo $_REQUEST['successMsg'];
                                                                        } ?></h2>
                                                                        </h2>
                    <h2 class="gradient-text"><?php if (isset($_REQUEST['msg'])) {
                                                                            echo $_REQUEST['msg'];
                                                                        } ?></h2>
                                </div>
                            </div>
...
<input type="hidden" name="news" value="1">
      ...
      <!-- Event snippet for Submit lead form - worldwidepublisher (1) conversion page -->
<script>
  gtag('event', 'conversion', {
      'send_to': 'AW-965452815/M2TxCMXO2NkZEI_IrswD',
      'value': 1.0,
      'currency': 'PKR'
  });
</script>
