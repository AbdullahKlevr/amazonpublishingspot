...
<head>
        ...
        <title>About Us | Worldwide Publisher </title>
    </head>
    <body class="">
        <!-- top-header -->
        <!-- header-start -->
        <div class="back-bg">
            ...
            <section id="banner" class="banneroad01 about">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-7">
            ...
            <div class="reviewlinks container p-5">
    <div class="row">
        <div class="col-md-3 d-flex justify-content-center align-items-center">
            <a href="https://www.trustpilot.com/review/worldwidepublisher.com">
                <img src="/assets/images/0.png" class="img-fluid mb-4" alt="">
            </a>
        </div>
        <div class="col-md-3 d-flex justify-content-center align-items-center">
            <a href="https://www.reviews.io/company-reviews/store/worldwidepublisher.com-nwz4rda">
                <img src="/assets/images/1.png" class="img-fluid mb-4" alt="">
            </a>
        </div>
        <div class="col-md-3 d-flex justify-content-center align-items-center">
            <a href="https://www.provenexpert.com/en-us/worldwide-publisher/?mode=preview">
                <img src="/assets/images/2.png" class="img-fluid mb-4" alt="">
            </a>
        </div>
        <div class="col-md-3 d-flex justify-content-center align-items-center">
            <a href="https://www.bark.com/en/us/company/worldwide-publisher/bRP71/">
                <img src="/assets/images/3.png" class="img-fluid mb-4" alt="">
            </a>
        </div>
    </div>
</div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 my-auto">
                            <h2 class="main-heading">We're Meticulously Sculpting Your Book Writing Journey</h2>
                            <p class="main-para">Worldwide Publisher  is a leading support for storytellers. Whether it is your autobiography, a work of fiction, or a work of history, we bring your vision to life in the form of a meticulously written and published book. <br>
                                <br> We have a team of highly experienced bookworms who are experts in their respective disciplines. We delivered thousands of successful, meticulously written, designed, edited, and published publications. In addition, many of our clients have become best-selling authors as a result of our excellence.
                            </p>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 ">
                            <div class="hwc-img">
                                <figure>
                                    <img src="images/img22.png" alt="how-we-can-image">
                                </figure>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <ul class="hlpwrap">
                                <li>
                                    <div class="lft">
                                        <figure>
                                            <img class="hvr-bob" src="images/researching.svg">
                                        </figure>
                                    </div>
                                    <div class="rht">
                                        <h3>We Do Research & Outline the  <br> Draft </h3>
                                        <p>After extensive research and understanding of your concept and specifications, we will craft a well-conceived plot.</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="lft">
                                        <figure>
                                            <img class="hvr-bob genu" src="images/genuine.svg">
                                        </figure>
                                    </div>
                                    <div class="rht">
                                        <h3>Writing Unique Content Based on Your Story or Idea</h3>
                                        <p>Once you approve the narrative outline, our writers will begin composing a unique and original first draft based on your concept.</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="lft">
                                        <figure>
                                            <img class="hvr-bob" src="images/critical.svg">
                                        </figure>
                                    </div>
                                    <div class="rht">
                                        <h3>Evaluation, Editing, And Proofreading</h3>
                                        <p>We continue to edit and revise the manuscript simultaneously throughout the entire writing process. After completion, our editors perform thorough proofreading.</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="lft">
                                        <figure>
                                            <img class="hvr-bob" src="images/formatting.svg">
                                        </figure>
                                    </div>
                                    <div class="rht">
                                        <h3>Extensive Formatting, Typesetting, And Designing</h3>
                                        <p> Once you have written, edited, proofread, and approved the manuscript, we start formatting thoroughly for publication.</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="lft">
                                        <figure>
                                            <img class="hvr-bob" src="images/branding.svg">
                                        </figure>
                                    </div>
                                    <div class="rht">
                                        <h3>Publishing, Branding, Promotions, And Marketing</h3>
                                        <p>After finalizing your book, we will publish it on the platform of your choice and promote it with an excellent book marketing approach.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="slutin">
                                ...
                                <h2 class="main-heading">Putting You Take the Controls.</h2>
                                <p class="main-para main-para-width">When you choose our book services, you have complete control over every detail. The decision is entirely yours, from editorial modifications to formatting to deciding the RRP! Our writers are enthusiastic, self-motivated, and capable of producing gorgeous literary works applicable to a vast array of niches, disciplines, and industries.</p>
                                <p class="main-para main-para-width">We are proud of our adaptability as we serve the following disciplines, specialties, and industries:</p>
                            </div>
                        </div>
                        <div class="col-lg-10 offset-lg-1">
                            <div class="wrap">
                                ...
                                <span>Give us a call <a href="tel:3235914113">Toll Free (323) 591-4113</a>
                                </span>
                            </div>
                        </div>
                    </div>
