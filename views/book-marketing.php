            ...
            <div class="col-md-12">
                <div class="row align-items-center">
                    ...
                    <div class="bnr-txt btn-tx-cp">
                        ...
                        <h2>Get Low-Cost Book Marketing Services for Self-Published Authors.</h2>
                       <p>You're still working on getting your book published. We have your back. We ensure that your work of art reaches the intended audience with zeal and dedication. Amazon Publishing Spot 's publishing team offers a strong, quick, and easy solution to publish your unique book.</p>
...
for All of Your Published Books
               ...
               <div class=" col-md-6 inner-tx-p">
                            <div class="inner-img-lp">
                                <img class="img-sec7" src="images/bookmarketing.png">
                            </div>
                        </div>
            </div>
        </div>
...
<section id="writing-ser">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="write-txt">
                    <h2>Our method of approach is concentric and revealing.</h2>
                ...
                <div class="col-md-6 col-lg-3 ser-img-box">
                    <div class="ser-box ser1">
                        ...
                        <div class="ser-box-txt">
                            ...
                            <p class="text-center">Our team, which specializes in various disciplines, whether a piece of history or an autobiography, guarantees exceptional content quality with unmatched support.</p>
            ...
            <div class="col-md-6">
                <div id="crtab2-1" class="tabcontent2" style="display: block;">
                    <div class="ctr-tavb-img">
                        <img class="img-fluid" src="images/publishing/1.png">
                    </div>
                </div>
                <div id="crtab2-2" class="tabcontent2" style="display: none;">
                    <div class="ctr-tavb-img">
                        <img class="img-fluid" src="images/publishing/2/">
                    </div>
                </div>
                <div id="crtab2-3" class="tabcontent2" style="display: none;">
                    <div class="ctr-tavb-img">
                        <img class="img-fluid" src="images/publishing/3/">
                    </div>
                </div>
                <div id="crtab2-4" class="tabcontent2" style="display: none;">
                    <div class="ctr-tavb-img">
                        <img class="img-fluid" src="images/publishing/4/">
                    </div>
                </div>
            </div>
                    ...
                    <div class="border-lt">
                        ...
                        <button class="tablinks2" onclick="openCity2(event, 'crtab2-2')">
                            <div class="tab-txt-2 tab-txt-img2">
                                <h3>Extensive proofreading and editing</h3>
                        ...
                        <button class="tablinks2" onclick="openCity2(event, 'crtab2-3')">
                            <div class="tab-txt-2 tab-txt-img3">
                                <h3>Perfecting each syllable</h3>
                        ...
                        <button class="tablinks2" onclick="openCity2(event, 'crtab2-4')">
                            <div class="tab-txt-2 tab-txt-img4">
                                <h3>Rectification and Software Scanning</h3>
