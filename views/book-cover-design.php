            ...
            <div class="col-md-12">
                <div class="row align-items-center">
                    ...
                    <div class="bnr-txt btn-tx-cp">
                        <h4>The book cover design should have an impact</h4>
                        <h2>Amazon Publishing Spot  Crafts The Most Creative Book Cover Designs</h2>
                       <p>A prominent design can influence how readers perceive a book. Amazon Publishing Spot 's innovative designers are well-versed in the art of generating sales through astonishing cover design.</p>
...
<h2 style="color:#000;font-size:40px;">Create account</h2>
	<div class="default-form">
		<form action="/leads/" method="POST" class="form-get-quote form_submission" id="contact-form">
		     <input type="hidden" name="url" value='book-cover-design.html'>
...
<section id="lp-writing">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                 <h2>Make your Book Cover stand out!</h2>
                 <br>
                <div class="inner-txt-p">
                                <p >Our industry-savvy designers utilize their unique artistic abilities to captivate the audience to create a compelling Cover that reveals more about the story. Amazon Publishing Spot  comprises dedicated designers who provide creative book cover designs to attract readers at first glance.</p>
                            </div>
                            <br>
                             <div class="cta-btn">
                ...
                <div class="col-md-6 col-lg-3 ser-img-box">
                    <div class="ser-box ser1">
                        ...
                        <div class="ser-box-txt">
                            ...
                            <p class="text-center">Our team, which specializes in various disciplines, whether a piece of history or an autobiography, guarantees an exceptional level of content quality with unmatched support.</p>
