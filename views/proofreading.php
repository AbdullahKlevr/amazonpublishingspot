  ...
  <!-- form-sec -->
    ...
    <section id="lp-writing">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h2>Perfecting Your Books With Unparalleled Editing And Proofreading Services.</h2>
                    <br>
                ...
                <div class=" col-md-6 inner-tx-p">
                    <div class="inner-img-lp">
                        <img class="img-sec8" src="images/proof-read.png">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="writing-ser">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="write-txt">
                        <h2>Our Approach Is Client-Centric And Bespoke</h2>
                    ...
                    <div class="col-md-6 col-lg-3 ser-img-box">
                        <div class="ser-box ser4">
                            ...
                            <div class="ser-box-txt">
                                ...
                                <p class="list-scroll">Based on your unique requirements and genre, we assign an expert
                                    to your project. We patiently listen to your instructions, formulate a schematic
                                    outline, and complete it within the estimated time promised.</p>
                    ...
                    <div class="col-md-6 col-lg-3 ser-img-box">
                        <div class="ser-box ser2">
                            ...
                            <div class="ser-box-txt">
                                ...
                                <p class="list-scroll">For us, no two clients and projects are alike. We offer a bespoke
                                    service and henceforth, we keep a particular emphasis on effective client
                                    communication to walk you through every step of the process. We stay true to our
                                    word and offer 100% client satisfaction.</p>
