...
<head>
   ...
   <!-- banner-start -->
<section id="banner" class="banneroad01 bpss new_amazon">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="row align-items-center">
                    ...
                    <div class="bnr-txt btn-tx-cp">
                        <h4>Publish your Stories Globally Through Our Book Publishing
Services</h4>
                        <h2>Let our Worldwide Publisher Services 
help you get 
your Book Published
</h2>
                       <p>Thousands of authors have spent many hours laboring over a manuscript, only to have it rejected by a publishing house for inexplicable reasons. Here at Worldwide Publisher , we offer services to help ambitious writers overcome the many "strange reasons" that prevent them from realizing their goals. If you're an aspiring author, our team of expert ghostwriting professionals can help you make your mark on Amazon and gain the recognition you deserve.</p>
                        
                    </div>
                     <div class="cta-btn btnres">

                     <a href="#" data-toggle="modal" data-target="#exampleModal" class="btn btnres1 pub2">Get A Quote</a>

                    <a href="javascript:;" onclick="LiveChatWidget.call('maximize');"  class="btn btnres2 pub" >Get Started</a>
...
<section id="lp-writing">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                 <h2>Offering the Best and Most Reliable 
Worldwide Publisher Experience 
Possible.
</h2>
                 <br>
                <div class="inner-txt-p">
                                <p> Worldwide Publisher  is a top-tier publishing house that excels across all categories, media types, and Amazon's publishing platform. Our book publishing agency has earned a solid reputation among authors after helping many aspiring novelists publish their works. The most competent writers from almost every field can be found at Worldwide Publisher  We guarantee you that our way of self-publishing services for your book is the quickest and the least difficult. With the competency of our top-tier Worldwide Publisher Services, many emerging writers have received the highest writing honors from Amazon.</p>
                            </div>
                            <br>
                             <div class="cta-btn">
...
<section id="writing-ser">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="write-txt">
                    <h2>Get answers to your questions about Amazon book publishing 
from our professional staff.
</h2>
                    <p>We consider it a pleasure to serve you with the finest content, as we want to keep your unwavering confidence.</p>
                ...
                <div class="col-md-6 col-lg-3 ser-img-box">
                    <div class="ser-box ser1">
                        ...
                        <div class="ser-box-txt">
                            ...
                            <p class="list-scroll">We have a team of experienced publishing agents who can assist or guide you through the maze of options available.</p>
                ...
                <div class="col-md-6 col-lg-3 ser-img-box">
                    <div class="ser-box ser4">
                        ...
                        <div class="ser-box-txt">
                            ...
                            <p class="list-scroll">When you provide us with a first draft and any special instructions for the project, we will deliver our best to live up to your standards and offer constructive criticism.</p>
                ...
                <div class="col-md-6 col-lg-3 ser-img-box">
                    <div class="ser-box ser2">
                        ...
                        <div class="ser-box-txt">
                            ...
                            <p class="list-scroll">We'll assign a seasoned book publishing expert to your project based on your needs. All of your requests are carefully considered.</p>
        ...
        <div class="row">
            ...
            <div class="col-md-12 cta-box">
                ...
                <div class="cta-txt">
                    ...
                    <h2>Need To Do a Book Discussion with an Expert?</h2>
                ...
                <div class="cta-btn">
                    ...
                    <a href="javascript:;" onclick="LiveChatWidget.call('maximize');"  class="cta-btn-2 liveChat" >Live Chat</a>
            ...
            <div class="container">
                <div class="col-md-12">
                    <div class="sample-txt">
                        ...
                        <p> We aim to provide you with the highest quality service at the most reasonable cost.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div id="crtab2-1" class="tabcontent2" style="display: block;">
                    <div class="ctr-tavb-img">
                        <img class="img-fluid lazy" src="images/publishing/1.png">
                    </div>
                </div>
                <div id="crtab2-2" class="tabcontent2" style="display: none;">
                    <div class="ctr-tavb-img">
                        <img class="img-fluid lazy" src="images/publishing/2/">
                    </div>
                </div>
                <div id="crtab2-3" class="tabcontent2" style="display: none;">
                    <div class="ctr-tavb-img">
                        <img class="img-fluid lazy" src="images/publishing/3/">
                    </div>
                </div>
                <div id="crtab2-4" class="tabcontent2" style="display: none;">
                    <div class="ctr-tavb-img">
                        <img class="img-fluid lazy" src="images/publishing/4/">
                    </div>
                </div>
            </div>
                    ...
                    <div class="border-lt">
                        <button class="tablinks2 btn-one-cr active" data-toggle="modal" data-target="#Mymodal" onclick="openCity2(event, 'crtab2-1')" id="defaultOpen2">
                            <div class="tab-txt-2 tab-txt-img1">
                                ...
                                <p>The client sends in the manuscript with specific guidelines for revision and publication.</p>
                            </div>
                        </button>
                        <button class="tablinks2" onclick="openCity2(event, 'crtab2-2')">
                            <div class="tab-txt-2 tab-txt-img2">
                                <h3>Revision and Editing</h3>
                                <p>We'll have a skilled editor read through, edit, and proofread the document thoroughly.</p>
                            </div>
                        </button>
                        <button class="tablinks2" onclick="openCity2(event, 'crtab2-3')">
                            <div class="tab-txt-2 tab-txt-img3">
                                <h3>Design, Layout, and Typography</h3>
                                <p>After editing, we adjust the typeface and add any necessary images or graphics to the manuscript.</p>
                            </div>
                        </button>
                        <button class="tablinks2" onclick="openCity2(event, 'crtab2-4')">
                            <div class="tab-txt-2 tab-txt-img4">
                                <h3>Book Cover Design</h3>
                                <p>Complete with a front and back cover, blurbs, author profile, table of contents, and disclaimer, this book is the product of our professional team.</p>
                            </div>
                        </button>
                    </div>
                </div>
