...
<head>
        ...
        <title>Portfolio | Amazon Publishing Spot </title>
    </head>
    <body class="">
        <!-- top-header -->
        <!-- header-start -->
        <div class="back-bg">
			...
			<section id="banner" class="banneroad01 portfolio">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-7">
                    ...
                    <div class="sample-tab exrtacss">
                        ...
                        <div id="tab1" class="tab-pane active show">
                            <div class="">
                                ...
                                <!--<div class="body-content">-->
                                <!--    <div class="cover">-->
                                <!--        <img class="" src="images/new-port/30.jpg" >-->
                                <!--    </div>-->
                                <!--</div>-->
                                <!--<div class="body-content">-->
                                <!--    <div class="cover">-->
                                <!--        <img class="" src="images/new-port/31.jpg" >-->
                                <!--    </div>-->
                                <!--</div>-->
                                <div class="body-content">
                                    <div class="cover">
