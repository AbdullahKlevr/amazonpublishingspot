...
<head>
        ...
        <title>E-Book Writing | Amazon Publishing Spot </title>
    </head>
    <body class="">
        <!-- top-header -->
        <!-- header-start -->
        <div class="back-bg">
            ...
            </style>                <section id="banner" class="banneroad01 ebkwriting">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <div class="bnr-txt btn-tx-cp">
                                        ...
                                        <h2>Elevate Your E-Book with Our Customized Writing Services</h2>
                                        <p>Our team of expert e-book writers offers affordable prices for your e-books with added benefits that elevate the quality of your writing. We are passionate about transforming your basic ideas into captivating e-books that leave a lasting impact. Let us deliver your magnificent e-book today.</p>
                                    </div>
...
<h2 style="color:#000;font-size:40px;">Create account</h2>
	<div class="default-form">
		<form action="/leads/" method="POST" class="form-get-quote form_submission" id="contact-form">
		     <input type="hidden" name="url" value='ebook-writing.html'>
           ...
           <input type="hidden" name="subject" value="Banner Form (amazonpublishingspot.com)">
            ...
            <section id="lp-writing">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h2>Experience the Power of Executive E-book Creation with Amazon Publishing Spot </a></h2>
                            <br>
                            <div class="inner-txt-p">
                                <p >In this digital era, we are your partners in ranking your e-books among the best worldwide. Our skilled storytellers maintain unwavering quality and standards in our e-book writing services. Our primary goal is to provide authentic leads that meet the expectations of our highly valued customers.</p>
                            </div>
                            <br>
                            <div class="cta-btn">
                                <a href="#" data-toggle="modal" data-target="#exampleModal" class="btn" >Get A Quote</a>
                                <a href="javascript:;" onclick="LiveChatWidget.call('maximize');return false;" class="btn liveChat" >Live Chat</a>
                            </div>
                        </div>
                        <div class=" col-md-6 inner-tx-p">
                            <div class="inner-img-lp">
                                <img class="img-sec3" src="images/e-bookwri.png">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="writing-ser">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="write-txt">
                            <h2>Our Client-Centric and Transparent Approach</h2>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 col-lg-3 ser-img-box">
                            <div class="ser-box ser1">
                                ...
                                <div class="ser-box-txt">
                                    ...
                                    <p class="text-center">We reach for the stars and beyond with our diverse team of specialists in multiple genres. Whether it's history, autobiography, or any other genre, we guarantee exceptional content quality and unparalleled support.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3 ser-img-box">
                    ...
                    <div class="container">
                        <div class="col-md-12">
                            <div class="sample-txt">
                                <h2><b>Explore Our Impressive Portfolio</b></h2>
                                <p>Our portfolio showcases the excellence and expertise we bring to every project. We at Amazon Publishing Spot  are committed to providing you with exceptional value and a personalized experience.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="creative-txt">
                            <h2 class="text-center">Our Streamlined Process</h2>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="border-lt">
                                <button class="tablinks2 btn-one-cr active" data-toggle="modal" data-target="#Mymodal" onclick="openCity2(event, 'crtab2-1')" id="defaultOpen2">
                                    <div class="tab-txt-2 tab-txt-img1">
                                        <h3>Thorough Research and Draft Outlining</h3>
                                        <p>We delve deep into understanding your requirements and craft a well-structured plot through extensive research.</p>
                                    </div>
                                </button>
                                <button class="tablinks2" onclick="openCity2(event, 'crtab2-2')">
                                    <div class="tab-txt-2 tab-txt-img2">
                                        <h3>Authentic and Engaging Writing </h3>
                                        <p>Once you approve our meticulously outlined draft, our skilled storytellers dive into bringing your ideas to life with captivating writing.</p>
                                    </div>
                                </button>
                                <button class="tablinks2" onclick="openCity2(event, 'crtab2-3')">
                                    <div class="tab-txt-2 tab-txt-img3">
                                        <h3>Rigorous Review, Editing, and Proofreading </h3>
                                        <p>In order to improve our writing process, we continue to conduct multiple rounds of revision on the manuscripts.</p>
                                    </div>
                                </button>
                                <button class="tablinks2" onclick="openCity2(event, 'crtab2-4')">
                                    <div class="tab-txt-2 tab-txt-img4">
                                        <h3>Formatting, Design, and Typesetting of Substantial Quality </h3>
