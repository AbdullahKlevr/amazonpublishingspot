                ...
                <div class="col-md-12">
                    <div class="row align-items-center">
                        ...
                        <div class="bnr-txt btn-tx-cp">
                            ...
                            <h2>Your Source for Book Printing and Delivery Services<br>of the Highest Quality.</h2>
                            <p>
                               Amazon Publishing Spot  understands both the expectations of authors and readers, having completed hundreds of book printing projects last year. Whether you require 100 or 10,000 copies, Amazon Publishing Spot  has your back!
                            </p>
                        </div>
...
<h2 style="color:#000;font-size:40px;">Create account</h2>
	<div class="default-form">
		<form action="/leads/" method="POST" class="form-get-quote form_submission" id="contact-form">
		     <input type="hidden" name="url" value='book-printing.html'>
...
<input type="hidden" name="news" value="1"><input type="text" name="honeypot" style="display: none;">
    ...
    <section id="lp-writing">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h2>Written, Formatted, And Designed, Your Book Is Complete. Next Steps?</h2>
                    <br>
                    <div class="inner-txt-p">
                        <p>
                            Once a book has been completed, the next stage is its publication and printing. We assist in making your book a cherished heirloom and relieve you of the trouble of locating a printer. Our book printing and shipping services are unfailingly individualized, immutable, and practical. In our master-certified in-house printing business, Amazon Publishing Spot  is committed to producing books of the highest quality. 
                            <br>
                            Every book we print in our facility satisfies the stringent requirements of digital printing, whether offset printing, print-on-demand, or short-run printing. Our printing press handles your books with extreme care and finesse.
                        </p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="write-txt">
                        <h4>Our Process </h4>
                        <h2>Standard and Individualized Method</h2>
                        ...
                        <div class="ser-box ser1">
                            ...
                            <div class="ser-box-txt">
                                ...
                                <p class="text-center list-scroll">
                                    With Amazon Publishing Spot , nothing is impossible. Our book printing team is familiar with your industry's standards. Regardless of the genre to which your book pertains, we print it according to the high standards of your genre.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3 ser-img-box">
                        <div class="ser-box ser4">
                            ...
                            <div class="ser-box-txt">
                                ...
                                <p class="list-scroll">
                                    Based on your specific needs and genre, our team of printing experts devises a foolproof strategy. We listen attentively to your instructions, design a plan, and meet the KPIs within the promised timeframe.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3 ser-img-box">
                        <div class="ser-box ser2">
                            ...
                            <div class="ser-box-txt">
                                ...
                                <p class="list-scroll">
                                    No two clients or initiatives are alike for us. We provide a customized service, and as a result, we place a premium on effective client communication to guide you through each stage of the procedure. We uphold our word and guarantee complete client satisfaction.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 cta-box">
                ...
                <div class="cta-txt">
                    ...
                    <h2>Take Your Book to New Heights</h2>

                    <p>Give our remarkable eBook writers a chance to prove to bring your ideas to life through meticulous writing and publication. Elevate your book to the next level with our dedicated services.</p>
