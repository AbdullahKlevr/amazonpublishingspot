...
<head>
        ...
        <title>Home | Worldwide Publisher Spot </title>
    </head>
    <body class="">
        <!-- top-header -->
        <!-- header-start -->
                    ...
                    <div class="col-md-6 col-lg-3 ser-img-box">
                        <div class="ser-box ser1">
                            ...
                            <div class="ser-box-txt">
                                ...
                                <p class="list-scroll">With Worldwide Publisher Spot , nothing is impossible. Our publishing team is familiar with your industry's standards. Regardless of the genre to which your book pertains, we publish it according to the high standards of your genre.</p>
        ...
        <section id="scnd-ftr" style="background:#020101de;">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="copy-txt">
                            <p style="font-size:12px; color:#fff;">Copyright © 2024 Worldwide Publisher Spot  . All Rights Reserved. </p>
                        </div>
                    </div>
