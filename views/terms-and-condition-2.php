...
<!-- banner-start -->
<section id="banner" class="banneroad01 termsand">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-7">
...
Welcome to the official corporate website of Amazon Publishing Spot  (the "Site"). This Site is owned by Amazon Publishing Spot , and we appreciate your visit. The purpose of this section is to outline the terms and conditions (the "Terms") that govern your access to and use of our Site. By accessing and using this Site, it is assumed that you understand and agree to be bound by these Terms. The following points are provided to enhance your understanding of the legal framework within which we operate:
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 rowss">
                ...
                <p>Ownership All the content displayed on this site is either owned by us or used with the owner's consent. While we encourage you to explore our Site and print copies of material for your personal, non-commercial use, any other form of copying is strictly prohibited, and all rights are reserved.
                </p>
                ...
                <p>No Warranty We provide this Site "as is." Although we take care to ensure the accuracy and completeness of the materials presented, we cannot guarantee the following:

                </p>
                <ul class="list-simple">
                    <li>	Compatibility of downloaded material or software with your equipment or freedom from viruses.</li>
                    <li>	Accuracy or completeness of all materials.</li>
                </ul>
                <br>
             

                <p>Limitation of Liability To the fullest extent permitted by law, we exclude all liability for any loss or damage (including direct, indirect, economic, or consequential loss or damage) incurred by you as a result of visiting or using this Site, accessing or downloading materials from it, or your inability to use this Site, including any errors in its provision or any computer viruses transmitted through this Site. This applies regardless of whether such loss or damage arises from our negligence or otherwise, and even if we are explicitly informed of the possibility of such loss or damage.</p>
                <!--<ul class="list-simple">-->
                ...
                <p>If you decide to cancel your order and discontinue our services before the project has commenced, you are eligible for a complete refund of 100% of the amount paid, excluding transaction charges.</p>
                <br>
               
                
                <p>Should you choose to discontinue our services while the project is still active, we will refund you the remaining balance of your order. However, any work already completed for your project will be retained, and the corresponding amount will not be refunded. It is important to note that no refund will be issued for a "change of mind" after the project work has commenced.</p>

                <br>
                
              
                <p>Any project, regardless of its status (active, on hold, in-progress, or completed), is ineligible for a partial or full refund if the payment for that project was made 90 days ago or more.</p>
                
                <br> 
               
                <p>If you have specific concerns and require a complete refund, please submit a refund request, and our team will make a decision accordingly.</p>
                
              
                <br>
                <p>Links to Third-Party Sites Links to third-party websites on this Site are provided solely for your convenience. By using these links, you will leave our Site. We have not reviewed all of these third-party websites and do not control or take responsibility for their content. Consequently, we do not endorse or make any representations about these websites or the materials found there, nor do we guarantee any results obtained from using them. Should you choose to access any of the third-party websites linked to our Site, you do so at your own risk.</p>
                
                <br>
             
                <p>Links to Our Site If you wish to create a link to our website, you may only do so under the following conditions:</p>
                <ul class="list-simple">

                    <li>You may link to the home page of our Site without replicating its content.</li>
                    <li>	Our images must not be removed, distorted, or altered in size or appearance.</li>
                    <li>	You must not create a frame or any other browser or border environment around our Site.</li>
                    <li>	You must not imply that we endorse any products or services other than our own.</li>
                    <li>	You must not misrepresent your relationship with us or provide false information about us.</li>
                    <li>	You must obtain written permission from us to use any trademarks displayed on our Site.</li>
                    <li>	The website from which you link to ours must be owned by you and comply with all applicable laws and regulations, ensuring that its content is neither distasteful, offensive, nor controversial, and that it does not infringe upon any intellectual property or other rights of any other person.</li>
                </ul>
                
                
                <br>
              
                <p>Other Legal Notices Specific areas of this Site may contain additional legal notices related to your use of those areas.</p>
                
                
                <br>
                <p>Changes to This Legal Notice We reserve the right to amend this legal notice periodically.</p>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="contact-box col-md-8">
                            <form class="cmxform form-get-quote form_submission"  method="POST" action="/leads/">
                                <input type="hidden" name="url" value='https://amazonpublishingspot.com/terms-and-condition'>
            ...
            <div class="formcontainer">
                <div class="banner-r">
                    ...
                    <form  class="form_submission form-get-quote" method="POST" action="/leads/">
                        <input type="hidden" name="url" value='terms-and-condition-2.html'>
           <input type="hidden" name="route" value="<?= $_SERVER['REQUEST_URI'] ?>">
<input type="hidden" name="brand" value="AMAZONPUBLISHINGSPOT">
<input type="hidden" name="token" value="<?= $token; ?>">
<input type="hidden" name="tag" value="top-form">
