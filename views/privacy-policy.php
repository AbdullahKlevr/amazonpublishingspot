    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center  mtpx-50">
                <h2 class="main-heading text-center">Privacy-Policy</h2>
                <p class="main-para">
This website is hosted by Amazon Publishing Spot , a company dedicated to safeguarding the privacy of its clients. The following statement provides a summary of how Amazon Publishing Spot  collects and utilizes information from clients and visitors to this website.
</p>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 rowss">
                <br>
                <h3>Data Policy at Amazon Publishing Spot </h3>

               
                <p>Our data policy outlines the types of information collected by Amazon Publishing Spot  and how this information is utilized to enhance the user experience and provide superior services to our clients.
                </p>
                ...
                <p>At Amazon Publishing Spot , we only collect essential information required for project development and implementation. This includes the client's name, email address, project requirements details, IP address, location, and contact number.
                ...
                <p>The information we collect is strictly used for communication, interaction, and improving the user experience for our clients based on their project requirements.</p>
                <!--<ul class="list-simple">-->
                ...
                <p>The information is shared among employees solely for the purpose of project development. However, we utilize the collected information as a reference only after receiving written or virtual confirmation and approval from the respective client.</p>
                <p>We never share or sell our clients' information collected for project development purposes.</p>
                <br>
              
                  <h3>Management and Deletion of Collected Information:</h3>
                <p>Our data team manages the collected information using our in-house secure CRM system. Clients have the discretion to change, modify, or delete their data with the assistance of our help desk.</p>
                <br>
               
                <h3>Responses to Legal Requests and Prevention of Harm:</h3>
                <p>The collected information is also used for account verification and prevention of spam or other malicious activities to ensure the integrity, safety, and security of our clients. In compliance with legal requests from law enforcement agencies or departments, we may share the collected information.</p>

                <br>
                
                <h3>Use, Operation, and Transfer of Collected Data:</h3>
                <p>The use, operation, and transfer of collected data are strictly limited to our company for project development purposes. Client data is never shared outside the company.</p>
                
                <br> 
               <h3>Notification of Policy Updates or Changes:</h3>
                <p>In the event of significant changes or updates to our policies, we will inform clients via email or through notifications on our website.</p>
                
              
                <br>
                <h3>Terms and Conditions:</h3>
                <p>For further details regarding the use, disclaimers, and limitations of liability governing the use of our website, please refer to our Terms and Conditions section.</p>
                
                <br>
             
                <p>Contact Amazon Publishing Spot  for Queries:
If you have any inquiries, please email us at info@amazonpublishingspot.com
</p>
